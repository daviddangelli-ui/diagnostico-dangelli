...
DIAGNOSTICO_MASTER = {
    "BLOCO 1: Governança Corporativa, Proteção Patrimonial e Sucessão": [
        ...
        {"id": "b1_17", "pergunta": "17. Foram feitas simulações sobre reestruturação societária (cisão, PJ operacional/patrimonial) diante das alterações do IRPJ/CSLL para as empresas optantes do lucro presumido com receita bruta anual acima de R$5.000,00, bem como o aumento em 10% a título de adicional de IRPF com retenção na fonte dos lucros/dividendos no momento de sua distribuição e/ou antecipação são superiores a R$50.000,00 por mês?", "opcoes": OPCOES_PADRAO},
